...
class RestrauntCaseStudy extends Component {
  ...
  componentDidMount() {
    ...
    let accessToRef = d3.select(this.myRef.current).append("div").attr("id", "parent");
    ...
    // d3.json("data/states.json").then(function(states) {
      d3.csv("data/restaurantData.csv").then(function(citiesData) {
        // console.log(states);
